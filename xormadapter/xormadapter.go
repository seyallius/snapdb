...
// snapdb.Engine interface. Users of xorm (casdoor, etc.) can pass an
...
// Adapter wraps a *xorm.Engine to satisfy snapdb.Engine.
type Adapter struct {
	eng *xorm.Engine
}

// compile-time interface check.
var _ snapdb.Engine = (*Adapter)(nil)
...
// responsible for closing it (which snapdb does via Engine.Close()).
...
// Ping implements snapdb.Engine.
func (a *Adapter) Ping() error { return a.eng.Ping() }

// Close implements snapdb.Engine.
func (a *Adapter) Close() error { return a.eng.Close() }

// ClearCache implements snapdb.Engine. Forwards to xorm.Engine.ClearCache,
